...
const About = () => {
    return (
        <div className="mt-4 p-6 w-screen mx-auto bg-gradient-to-t from-[#eeeedc] from-95% to-white text-[#333333] md:my-16">
            <div className="mx-4 md:mx-[10vw] lg:mx-[20vw]">
                <h1 className="text-4xl font-light my-4 sm:my-8 md:my-12 md:mt-16 text-center">What is the Learning Model?</h1>
