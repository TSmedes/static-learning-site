...
const Model = () => {
    return (
        <div className="p-6 py-4 sm:py-8 md:p-16 text-[#333333]">
            <div className='mx-4 md:mx-[10vw] lg:mx-[20vw]'>
                <div className="mb-8">
                    ...
                    <p className="mb-4 md:mb-12 font-thin">
                        &emsp;Dr. Robert Horn researched how the human brain learns. Actually, his focus was researching other people's work on how people learn. As a result, he concluded there was six kinds of information. He developed a methodology to organize information based on how the human brain works, called "Information Mapping". Out of his research others such as Dr. Ruth Clark developed a process for developing lessons for how to best learn each type of information.
                    </p>
                ...
                <p className="mb-4 font-thin">
                        &emsp;Identifying which information types learners need helps the teacher to stay foused on what is being learned.
                </p>
